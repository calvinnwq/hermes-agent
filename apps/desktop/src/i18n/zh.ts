...
export const zh: Translations = {
  ...
  desktop: {
    ...
    yoloStatusOn: sessionScoped => (sessionScoped ? '此会话的 YOLO 状态已开启。' : 'YOLO 状态已开启。'),
    yoloStatusOff: sessionScoped => (sessionScoped ? '此会话的 YOLO 状态已关闭。' : 'YOLO 状态已关闭。'),
    yoloStatusUnavailable: '/yolo status 在此后端不可用。请升级 Hermes Agent 以使用此只读查询。',
    yoloTitle: 'YOLO',
