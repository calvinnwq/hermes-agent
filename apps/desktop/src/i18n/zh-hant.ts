...
export const zhHant = defineLocale({
  ...
  desktop: {
    ...
    yoloStatusOn: sessionScoped => (sessionScoped ? '此工作階段的 YOLO 狀態已開啟。' : 'YOLO 狀態已開啟。'),
    yoloStatusOff: sessionScoped => (sessionScoped ? '此工作階段的 YOLO 狀態已關閉。' : 'YOLO 狀態已關閉。'),
    yoloStatusUnavailable: '/yolo status 在此後端無法使用。請升級 Hermes Agent 以使用此唯讀查詢。',
    yoloTitle: 'YOLO',
