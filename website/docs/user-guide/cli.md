...
| ⚠ YOLO | **YOLO mode warning** - shown when a launch setting or session toggle enables YOLO mode. See [Security: YOLO Mode](./security.md#yolo-mode) for all effective-mode sources. |
